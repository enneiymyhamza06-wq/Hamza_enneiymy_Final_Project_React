...
function Products() {
  ...
  return (
    <section  className='bg-full h-full pb-30'>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-190 w-full h-100 p-2">
    {visibleProducts.map((item) => (
        <div key={item.id} className="cursor-pointer">     
        <div className="w-full h-120 bg-gray-800 rounded overflow-hidden">
